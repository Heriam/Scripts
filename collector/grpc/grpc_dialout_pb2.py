...
DialoutMsg = _reflection.GeneratedProtocolMessageType('DialoutMsg', (_message.Message,), dict(
...
DialoutResponse = _reflection.GeneratedProtocolMessageType('DialoutResponse', (_message.Message,), dict(
